...
export const datasets: Array<{ id: string; title: BilingualText; status: BilingualText; description: BilingualText }> = [
  { id: 'primate-behavior', title: { en: 'Non-human Primate Behavior Datasets', zh: '非人灵长类行为数据' }, status: { en: 'Under internal review', zh: '内部审核中' }, description: { en: 'Curated resources supporting fine-grained behavior understanding and longitudinal observation.', zh: '面向细粒度行为理解与长期观察的整理资源。' } },
